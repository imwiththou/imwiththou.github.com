...
function cleanretina_add_shortcodes() {
	...
	add_shortcode( 'tr-link', 'cleanretina_translator_link_shortcode' );
...
/**
 * Shortcode to display a link to yiranboke.com.
 *
 * @return string
 */
function cleanretina_translator_link_shortcode() {
   return '<a href="'.esc_url( 'http://yiranboke.com' ).'" target="_blank" title="' . esc_attr__( '怡然博客', 'cleanretina' ) . '"><span>' . __( '怡然博客', 'cleanretina' ) . '</span></a>';
}
/**
